...
message(STATUS "follow: 3 messages, 0 services")

set(MSG_I_FLAGS "-Ifollow:/home/geely/robot_dog_control_osqp/src/follow/msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg;-Igeometry_msgs:/opt/ros/melodic/share/geometry_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/geely/robot_dog_control_osqp/src/follow/msg/ObstaclePoint.msg" NAME_WE)
add_custom_target(_follow_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "follow" "/home/geely/robot_dog_control_osqp/src/follow/msg/ObstaclePoint.msg" ""
)

get_filename_component(_filename "/home/geely/robot_dog_control_osqp/src/follow/msg/position.msg" NAME_WE)
add_custom_target(_follow_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "follow" "/home/geely/robot_dog_control_osqp/src/follow/msg/position.msg" ""
)

get_filename_component(_filename "/home/geely/robot_dog_control_osqp/src/follow/msg/ObstaclePointList.msg" NAME_WE)
add_custom_target(_follow_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "follow" "/home/geely/robot_dog_control_osqp/src/follow/msg/ObstaclePointList.msg" "follow/ObstaclePoint"
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/follow)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/follow\")")
  # install generated code
  install(
